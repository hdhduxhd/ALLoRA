...
class BaseLearner(object):
    ...
    def eval_task(self):
        # y_pred, y_pred_with_task, y_true, y_pred_task, y_true_task, y_pred_task_keys, y_pred_with_task_on_key = self._eval_cnn(self.test_loader)
        ...
        # return cnn_accy, cnn_accy_with_task, nme_accy, cnn_accy_task, cnn_accy_task_keys, cnn_accy_with_task_on_key
