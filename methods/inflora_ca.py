        ...
        for i, (_, inputs, targets) in enumerate(loader):
            ...
            with torch.no_grad():
                if isinstance(model, nn.DataParallel):
                    outputs, _ = model.module.interface(inputs)
                else:
                    outputs, _ = model.interface(inputs)
    ...
    def _eval_cnn(self, loader):
        ...
        for _, (_, inputs, targets) in enumerate(loader):
            ...
            with torch.no_grad():
                ...
                if isinstance(self._network, nn.DataParallel):
                    outputs, _ = self._network.module.interface(inputs)
                else:
                    outputs, _ = self._network.interface(inputs)
